...
class AlinaDB(object):
    ...
    def help(self):
        ...
        print("+========================================================+")
        print("insert <key> <data> \t\t\t insert/add data into Database")
        print("delete <key> \t\t\t\t delete/remove data from Database of given key")
        print("get <key> \t\t\t\t Show value of given key")
        print("show all \t\t\t\t Show all data on Database")
        print("show dbs \t\t\t\t show/list all Databases")
        ...
        print("show privelege \t\t\t\t show current user's priveleges")
        print("get all from <collection_name> \t\t get all value from collection")
        print("create <collection_name> \t\t create a collection into current Database")
        print("get from <collection_name> <key> \t get value for given key from collection")
        print("update <collection_name> <key> <value> \t Update data into collection")
        print("show all <collection_name> \t\t show all collections in current Database")
        print("quit or exit \t\t\t\t exiting Database program")
